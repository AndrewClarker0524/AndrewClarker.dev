...
import andrewClarker from "../public/andrew.webp";
    ...
    >
      <section id="whoami" className="section">
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-3 grid-cols-5">
              ...
              <div className="relative w-72">
                ...
                <div className="profile-picture overflow-hidden md:overflow-visible rounded-md md:shadow-2xl">
                  <Image
                    ...
                    height={1790}
                    priority
                    alt="Andrew Clarker profile picture"
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              I have over a decade of experience in web and mobile
              application development, with a strong focus on front-end
              engineering.
              As a Senior Full Stack Engineer at Katalyst Technologies, I led a
              team of 5 engineers and 3 designers, ensuring successful
              project delivery and enhancing product performance by 30%.
              Previously, at Breathing.ai and Giovvani, I specialized in creating
              visually appealing websites and implementing functionalities using
              technologies like React, JavaScript, and CMS platforms.
              My skill set includes expertise in ReactJS, Next.js, Redux, and
              AWS, enabling me to optimize performance and user experience
              effectively.
            </p>

            <div
              className="col-start-3 col-end-6 row-start-1 row-end-3 lg:row-start-2 lg:row-end-3 md:ml-3 place-content-start"
              ref={eduRef}
            >
...
const educationInfo = [
  {
    ...
    subTitle: "Saint Mary's University | 2013 ~ 2017",
    list: [
